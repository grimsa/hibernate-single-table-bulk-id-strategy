...
public abstract class AbstractSingleGlobalTemporaryTableBulkIdStrategyTest extends BaseCoreFunctionalTestCase {
    ...
    protected MessageCapturingAppender sqlAppender;
    ...
    protected void prepareTest() throws Exception {
        ...
        openSession();
        if (!ddlExecuted) {
            doInTransaction(() -> session.createNativeQuery("create global temporary table HT_TEMP_IDS (" + getIdColumnName() + " CHAR(36), ENTITY_NAME VARCHAR(100))").executeUpdate());
            ddlExecuted = true;
        }
    ...
    protected static class MessageCapturingAppender extends AppenderSkeleton {
